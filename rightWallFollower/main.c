...
#define DRIVE_TARGET_TICKS 4000
...
int i=0;
double drift = 0.096;
int backwards = DRIVE_TARGET_TICKS/55;
double speed = 2;
...

{
    ...
    while (1)
    {
        ...
        case DRIVEFORWARD:
            ...
            set_left_motor_direction(true);
            set_right_motor_direction(true);
            set_left_motor_pwm(.1*speed);
            set_right_motor_pwm(drift*speed);
        ...
        case BACKWARDS:
            ...
            left_done = (left_encoder_zero_pos - get_left_motor_count()) > DRIVE_TARGET_TICKS/55;
            right_done = (right_encoder_zero_pos - get_right_motor_count()) > DRIVE_TARGET_TICKS/55;
