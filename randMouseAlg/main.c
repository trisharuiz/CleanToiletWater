    ...
    while (1)
    {
        ...
        case DRIVEFORWARD:
            ...
            if (bump_data1 == 1)
                ...
                // || bump_data3
            if (bump_data2 == 1 || bump_data3 == 1){
               mouse = rand() %3 +1; //generate random # 1-3
               if (mouse == 1)
                   state = SETUP_BACKWARDS; //TURN LEFT 45
               else
               if (mouse == 2)
                   state = SETUP_BACKWARDS3; //TURN RIGHT 45
               else
               if (mouse == 3)
                    state = SETUP_BACKWARDS2; //TURN RIGHT 90
            }
            else
            if (bump_data4 == 1)
                state = SETUP_BACKWARDS3; //RIGHT 45
            else
            if (bump_data5 == 1)
